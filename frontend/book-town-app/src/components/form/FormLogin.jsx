...
function FormLogin() {
  ...
  return (
    <form className="bg-gray-900 px-12 pt-4 pb-6 sm:px-16 max-sm:rounded-none rounded-3xl border-2 shadow-lg shadow-gray-900 lg:px-8 xl:px-10 xl:py-8 2xl:px-12 2xl:py-16" onSubmit={handleSubmit(submit)}>
